...
UTILS void vhashtable_insert(VHashTable *table, str key, C8NS(API_FUNC_PTR) value) {
...
UTILS C8NS(API_FUNC_PTR) vhashtable_get(VHashTable *table, str key) {
  if (table == NULL || key.data == NULL)
    return 0;
